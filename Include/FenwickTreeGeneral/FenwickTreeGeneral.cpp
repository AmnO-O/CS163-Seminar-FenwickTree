...
//template <typename T>
//FenwickTreeGeneral<T>::FenwickTreeGeneral(int sz)
//	: n{ sz },                   
//	BIT(n > 0 ? n + 1 : 1, T{}) 
//{
//	if (sz < 0) {
...
//	int index = 0;
//
//	int LOG = 0; // Logarithm base 2 of n
//	while ((1 << LOG) <= n) LOG++;
//
//	for (int i = LOG; i >= 0; --i) {
...
//	}
//
//	if (index == n) return T{}; // k is out of bounds
//
...
//template <typename T>
//void FenwickTreeGeneral<T>::how_to_use(void) const {
//	std::cout << std::endl;
